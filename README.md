...
- Evaluation
  ...
  - Bulk nivolumab-treated patient's data processing `notebooks/validation/anti_pd1/bulk/Braun_all.ipynb`
    - the data was downloaded from the publication (Supplementary information)
